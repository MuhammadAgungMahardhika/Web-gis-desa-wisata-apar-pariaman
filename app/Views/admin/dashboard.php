        ...
        <div class="card-body">
            <section id="groups">
                <div class="row d-flex ">
                    ...
                    <div class="col-md-3">
                        <div class="card  shadow efek" id="package">
                            <div class="card-content">
                                <a href="<?= base_url('manage_atraction') ?>">
                    ...
                    <div class="col-md-3">
                        <div class="card  shadow efek" id="sp">
                            <div class="card-content">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card  shadow efek" id="wp">
                            <div class="card-content">
                    ...
                    <div class="col-md-3">
                        <div class="card  shadow efek" id="f">
                            <div class="card-content">
